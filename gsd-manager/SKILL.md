...
Project context, phase list, dependencies, and recommendations are resolved inside the workflow using `gsd-sdk init manager`. No upfront context loading needed.
</context>
