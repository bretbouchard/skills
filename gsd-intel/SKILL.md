...
Intel system is disabled. To activate:
  ...
  gsd-sdk config-set intel.enabled true
...
Project root: ${CWD}
Prefer: gsd-sdk <subcommand> (installed gsd-sdk on PATH). Legacy: node $HOME/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. Use `gsd-sdk intel extract-exports <file>` to analyze source files
5. Use `gsd-sdk intel patch-meta <file>` to update timestamps after writing
6. Use `gsd-sdk intel validate` to check your output
