---
name: writing
description: "AI prose ruleset (compact) — draft and revise prose that fits the medium, not an abstract idea of good writing. For blog posts, articles, docs, criticism, emails, marketing, UI text. Not for code comments, commit messages, or private notes."
license: MIT
metadata:
  author: Anbeeld
  version: '1.3.1'
  source: https://github.com/Anbeeld/WRITING.md
  variant: compact (~1200 words)
---
