...
Context files (CLAUDE.md, SUMMARY.md, phase state) are resolved inside the workflow via `gsd-sdk init phase-op` and delegated to agent via `<files_to_read>` blocks.
</context>
